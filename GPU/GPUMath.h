...
#define UADDC(c, a, b) \
  asm volatile("addc.cc.u64 %0, %1, %2;" : "=l"(c) : "l"(a), "l"(b) : "memory");
...
#define USUBC(c, a, b) \
  asm volatile("subc.cc.u64 %0, %1, %2;" : "=l"(c) : "l"(a), "l"(b) : "memory");
...
#define MADDO(r, a, b, c) \
  asm volatile("mad.hi.cc.u64 %0, %1, %2, %3;" : "=l"(r) : "l"(a), "l"(b), "l"(c) : "memory");
#define MADDC(r, a, b, c) \
  asm volatile("madc.hi.cc.u64 %0, %1, %2, %3;" : "=l"(r) : "l"(a), "l"(b), "l"(c) : "memory");
#define MADD(r, a, b, c) \
  asm volatile("madc.hi.u64 %0, %1, %2, %3;" : "=l"(r) : "l"(a), "l"(b), "l"(c));
#define MADDS(r, a, b, c) \
  asm volatile("madc.hi.s64 %0, %1, %2, %3;" : "=l"(r) : "l"(a), "l"(b), "l"(c));

// SECPK1 endomorphism constants
__device__ __constant__ uint64_t _beta[] = {0xC1396C28719501EEULL, 0x9CF0497512F58995ULL,
                                            0x6E64479EAC3434E9ULL, 0x7AE96A2B657C0710ULL};
__device__ __constant__ uint64_t _beta2[] = {0x3EC693D68E6AFA40ULL, 0x630FB68AED0A766AULL,
...
#define _IsOne(a) \
  ((a[4] == 0ULL) && (a[3] == 0ULL) && (a[2] == 0ULL) && (a[1] == 0ULL) && (a[0] == 1ULL))
...
__device__ void _DivStep62(uint64_t u[5], uint64_t v[5], int32_t* pos, int64_t* uu, int64_t* uv,
...
__device__ void MatrixVecMulHalf(uint64_t dest[5], uint64_t u[5], uint64_t v[5], int64_t _11,
...
__device__ void MatrixVecMul(uint64_t u[5], uint64_t v[5], int64_t _11, int64_t _12, int64_t _21,
                             int64_t _22) {
  uint64_t t1[NBBLOCK];
  uint64_t t2[NBBLOCK];
  uint64_t t3[NBBLOCK];
